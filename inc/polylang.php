 ...
 */
if ( ! function_exists( 'wl_language_switcher_function' ) ) {
	function wl_language_switcher_function( $mobile = false ) {
		$menu_html = '';
	...
	add_action( 'wl_language_switcher', 'wl_language_switcher_function', 10, 1 );
}
